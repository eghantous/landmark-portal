app.controller('projectVerifyCtrl',
  ['$scope'
  ,'$http'
  ,'$routeParams'
  ,'$location'
...
function projectVerifyCtrl($scope
                         , $http
                         , $routeParams
                         , $location
                          ) {
...
//    var url = '/ng/project-verify/sample-get_griddata2.json';
  ...
  $scope.togglePanel = function(panelId) {
    if( panelId == 'classifier-settings' ) {
      $scope.show_classifiersettings_panel = !$scope.show_classifiersettings_panel;
    ...
    if( panelId == 'page-select' ) {
      $scope.show_classifiersettings_panel = false;
